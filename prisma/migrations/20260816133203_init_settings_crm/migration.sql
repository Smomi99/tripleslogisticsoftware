...
-- Note: created_by / updated_by foreign keys were originally declared here.
-- They now live in prisma/schema.prisma as modelled relations, because an
-- appendix-only constraint is invisible to Prisma and gets dropped by the next
-- migrate dev.
-- -------------------------------------------------------------------------
